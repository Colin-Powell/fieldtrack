                          ...
                          children: [
                            Row(
                              children: [
                                const CircleAvatar(
                                  radius: 40,
                                  backgroundColor: Color(0xFF169B45),
                                  child: Text(
                                    'A',
                                    style: TextStyle(
                                      fontFamily: 'Poppins',
                            ...
                            const SizedBox(height: 24),
                            _buildTextField('Phone Number', '+254 700 000000'),
                            const SizedBox(height: 32),
                            ElevatedButton(
                              onPressed: () {},
                              ...
                              child: const Text('Save Profile Updates', style: TextStyle(color: Colors.white)),
                            ),
                          ],
                        ),
                      ),
                              ...
                              children: [
                                ...
                                OutlinedButton(
                                  ...
                                  style: OutlinedButton.styleFrom(
                                    ...
                                    side: const BorderSide(color: Color(0xFF169B45)),
                                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(40)),
                                  ),
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Recent Activity', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, fontWeight: FontWeight.w600)),
                        const SizedBox(height: 24),
                        Expanded(
                          child: ListView(
                            children: [
                              _buildActivityTimeline('Logged in from Chrome on Windows', 'Today, 09:20 AM'),
                              _buildActivityTimeline('Created a new supervisor profile', 'Yesterday, 14:30 PM'),
                              _buildActivityTimeline('Changed system GPS tracking radius', 'Yesterday, 11:15 AM'),
                              _buildActivityTimeline('Logged out', '2 Days Ago'),
                            ],
                          ),
                        ),
                      ],
