...
class SupervisorForgotPasswordScreen extends ConsumerStatefulWidget {
  const SupervisorForgotPasswordScreen({super.key});

  @override
  ConsumerState<SupervisorForgotPasswordScreen> createState() => _SupervisorForgotPasswordScreenState();
}

class _SupervisorForgotPasswordScreenState extends ConsumerState<SupervisorForgotPasswordScreen> {
