...
class SupervisorResetPasswordScreen extends ConsumerStatefulWidget {
  const SupervisorResetPasswordScreen({super.key});

  @override
  ConsumerState<SupervisorResetPasswordScreen> createState() => _SupervisorResetPasswordScreenState();
}

class _SupervisorResetPasswordScreenState extends ConsumerState<SupervisorResetPasswordScreen> {
