...
export const getDashboardRecentActivities = async (req, res) => {
    try {
        const supervisorId = req.user?.userId;
        const supervisorProfile = await prisma.supervisorProfile.findUnique({
            where: { userId: supervisorId },
...
export const getDashboardPendingReviews = async (req, res) => {
    try {
        const supervisorId = req.user?.userId;
        const supervisorProfile = await prisma.supervisorProfile.findUnique({
            where: { userId: supervisorId },
...
export const getStudentDailyLogs = async (req, res) => {
    try {
        const studentId = req.params.id;
        const logs = await prisma.fieldLog.findMany({
            where: { studentId },
...
export const getStudentActivityEvidence = async (req, res) => {
    try {
        const activityId = req.params.activityId;
...
export const getLiveMapLocations = async (req, res) => {
    try {
        const supervisorId = req.user?.userId;
        const supervisorProfile = await prisma.supervisorProfile.findUnique({
            where: { userId: supervisorId },
