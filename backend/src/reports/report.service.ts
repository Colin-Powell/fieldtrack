...
import { FieldLog, User } from '@prisma/client';

type LogWithUser = FieldLog & { user: User };

export class ReportService {
  /**
   * Generates a CSV string from an array of FieldLogs
   */
  static generateCSV(logs: LogWithUser[]): string {
   ...
   */
  static async generatePDF(logs: LogWithUser[], title: string = 'FieldTrack Supervisor Report'): Promise<Buffer> {
